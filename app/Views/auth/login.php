    ...
    <div class="login-form-panel">
      <div class="form-content">
        ...
        <form action="<?= base_url('/login/process') ?>" method="post" class="login-form">
          ...
          <!-- Ganti bagian checkbox dengan ini: -->
          <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  rememberCheckbox.addEventListener('change', function() {
    if (this.checked) {
      checkboxLabel.style.color = '#4a90e2';
      checkboxLabel.style.fontWeight = '600';

      // Show info tooltip
      if (!document.querySelector('.remember-info')) {
        const infoDiv = document.createElement('div');
        infoDiv.className = 'remember-info';
        infoDiv.innerHTML =
          '<small class="text-info"><i class="fas fa-info-circle me-1"></i>Anda akan login otomatis selama 30 hari</small>';
        rememberCheckbox.parentElement.appendChild(infoDiv);
      }
    } else {
      ...
      // Remove info tooltip
      const infoDiv = document.querySelector('.remember-info');
      if (infoDiv) {
        infoDiv.remove();
      }
    }
