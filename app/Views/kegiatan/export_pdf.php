    ...
    <div class="summary-section">
      ...
      <?php if (!$anggota_aktif_di_kegiatan_lain): ?>
        <div class="summary-row">
          ...
          <span class="summary-value summary-negative">- Rp <?= number_format($potongan_tidak_nulis, 0, ',', '.') ?></span>
        </div>
      <?php else: ?>
        <div class="summary-row">
          <span class="summary-label">Bonus Aktif Kegiatan Lain (<?= $jumlah_kegiatan_ikut ?>x ikut):</span>
